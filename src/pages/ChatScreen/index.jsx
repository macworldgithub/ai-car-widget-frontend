...
//   useEffect(() => {
//     const isDismissed = Cookies.get("chatButtonDismissed");
//     if (isDismissed === "true") {
...
//     setIsButtonVisible(false);
//     Cookies.set("chatButtonDismissed", "true", { expires: 7 });
//   };
...
export default function ChatWidget() {
  ...
  const [isButtonVisible, setIsButtonVisible] = useState(() => {
    ...
    // console.log("Cookie:", isDismissedCookie, "Storage:", isDismissedStorage); // Debug
  ...
  // Dismiss button handler
  const handleDismissButton = () => {
    // console.log("Dismissing widget"); // Debug
    setIsButtonVisible(false);
  ...
  // Show button handler
  const handleShowButton = () => {
    // console.log("Showing widget"); // Debug
    setIsButtonVisible(true);
    Cookies.remove("chatButtonDismissed", {
      path: "/",
      domain: window.location.hostname,
